  ...
  const reasons = [
    {
      ...
      desc: "Nguyên liệu hoàn toàn từ thiên nhiên, không chất bảo quản, không phẩm màu.",
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      title: "Tươi Ngon & Tinh Khiết",
      desc: "Chế biến theo quy trình khép kín, đảm bảo tươi ngon và giữ trọn dưỡng chất.",
    },
  ];
    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <p className="text-gold text-sm font-light tracking-[0.3em] uppercase mb-3">Ưu Điểm</p>
