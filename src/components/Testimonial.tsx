  ...
  const testimonials = [
    {
      ...
      content:
        "Bao bì rất đẹp và sang trọng! Thiết kế tinh tế, rất phù hợp để làm quà tặng. Khi mở hộp ra, cảm giác rất yên tâm về chất lượng. Sản phẩm tuyệt vời, xứng đáng với giá tiền!",
      rating: 5,
    },
    {
      name: "Trần Văn Đức",
    ...
    <section className="py-20 bg-cream relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          <p className="text-gold text-sm font-light tracking-[0.3em] uppercase mb-3">Cảm Nhận</p>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((t, i) => (
            <div
              key={i}
              className="bg-white rounded-2xl p-8 shadow-sm border border-gold/10 hover:shadow-lg hover:shadow-burgundy/5 transition-all duration-300 relative"
            >
              {/* Quote mark */}
              ...
              {/* Content */}
              <p className="text-gray-600 font-light text-sm leading-relaxed mb-6 italic">
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-gold/10">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 font-light">Khách hàng thân thiết</p>
                </div>
              </div>
            </div>
          ))}
