    ...
    <section id="membership" className="py-20 bg-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <p className="text-gold text-sm font-light tracking-[0.3em] uppercase mb-3">Đặc Quyền</p>
          ...
          <div className="bg-white rounded-2xl overflow-hidden border border-gold/10 shadow-sm hover:shadow-xl hover:shadow-burgundy/5 transition-all duration-500 group">
            <div className="bg-gradient-to-br from-burgundy to-burgundy-900 p-8 text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-white/60 text-sm font-light">Tích điểm mỗi đơn hàng</p>
              </div>
            </div>
            <div className="p-6">
              <ul className="space-y-3">
                {[
                  ...
                  "Giảm giá độc quyền cho thành viên",
                ].map((item, i) => (
          ...
          <div className="bg-white rounded-2xl overflow-hidden border border-gold/10 shadow-sm hover:shadow-xl hover:shadow-burgundy/5 transition-all duration-500 group">
            <div className="bg-gradient-to-br from-gold to-gold-600 p-8 text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-white/70 text-sm font-light">Nhận thưởng khi giới thiệu</p>
              </div>
            </div>
            <div className="p-6">
              <ul className="space-y-3">
                {[
                  "Nhận 50.000đ cho mỗi lần giới thiệu",
                  "Bạn bè được giảm 10% đơn đầu",
                  "Không giới hạn số lần giới thiệu",
                  "Thăng hạng VIP nhanh chóng",
                ].map((item, i) => (
                  <li key={i} className="flex items-start gap-3">
                    <svg className="w-5 h-5 text-gold flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
